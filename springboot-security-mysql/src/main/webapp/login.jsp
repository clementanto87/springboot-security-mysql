	...
	<div class="container">
		...
		<div class="col-md-4">
			<form action="/login" method="post">
				...
				<br> <br> <label style="color: black">First time
					user click <a href="signup">here</a> for registration
				</label> <label><a href="#">Forget password</a></label>

			</form>
		</div>

	</div>
	<!--  Include Navbar.jsp for top navigation ends  -->
